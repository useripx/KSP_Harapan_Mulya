...
--
-- Host: 127.0.0.1
-- Generation Time: May 09, 2026 at 01:24 PM
...
INSERT INTO `anggota` (`id`, `user_id`, `no_anggota`, `nama`, `tipe`, `identitas_no`, `prodi_unit`, `no_hp`, `alamat`, `tgl_daftar`, `status`, `status_validator`, `created_at`, `updated_at`) VALUES
(3, 6, 'A003', 'Budi Santoso', 'KARYAWAN TETAP', '3578012345670003', 'Administrasi', '081234567892', 'Jl. Pemuda No. 30, Surabaya', '2024-03-10', 'AKTIF', 0, '2026-03-15 09:45:52', '2026-04-24 12:45:31'),
(4, 7, 'A004', 'Dewi Lestari', 'KARYAWAN TETAP', '3578012345670004', 'Manajemen', '081234567893', 'Jl. Sudirman No. 15, Surabaya', '2024-04-05', 'AKTIF', 0, '2026-03-15 09:45:52', '2026-04-24 12:45:31'),
(5, 8, 'A005', 'Eko Prasetyo', 'KARYAWAN TETAP', '3578012345670005', '-', '081234567894', 'Jl. Diponegoro No. 45, Surabaya', '2024-05-12', 'AKTIF', 0, '2026-03-15 09:45:52', '2026-04-24 12:45:31'),
(6, NULL, 'A006', 'Fitri Handayani', 'KARYAWAN TETAP', '3578012345670006', 'Teknik Sipil', '081234567895', 'Jl. Gatot Subroto No. 20, Surabaya', '2024-06-18', 'AKTIF', 0, '2026-03-15 09:45:52', '2026-04-24 12:45:31'),
(7, NULL, 'A007', 'Gilang Ramadhan', 'DOSEN TETAP', '3578012345670007', 'Fakultas Hukum', '081234567896', 'Jl. Ahmad Yani No. 12, Surabaya', '2024-07-22', 'AKTIF', 0, '2026-03-15 09:45:52', '2026-04-24 12:45:31'),
(8, NULL, 'A008', 'Hana Putri', 'KARYAWAN TETAP', '3578012345670008', 'Sistem Informasi', '081234567897', 'Jl. Basuki Rahmat No. 8, Surabaya', '2024-08-30', 'AKTIF', 0, '2026-03-15 09:45:52', '2026-04-24 12:45:31'),
(9, NULL, 'A009', 'Irfan Hakim', 'KARYAWAN TETAP', '3578012345670009', 'IT Support', '081234567898', 'Jl. Veteran No. 5, Surabaya', '2024-09-14', 'AKTIF', 0, '2026-03-15 09:45:52', '2026-04-24 12:45:31'),
(10, NULL, 'A010', 'Julia Rahayu', 'KARYAWAN TETAP', '3578012345670010', '-', '081234567899', 'Jl. Raya Darmo No. 100, Surabaya', '2024-10-20', 'AKTIF', 0, '2026-03-15 09:45:52', '2026-04-24 12:45:31'),
(12, 11, 'YA0001', 'Yogi Ario P', 'KARYAWAN TETAP', '2313020004', 'Teknik Informatika', '081358113087', 'LAMONG, BADAS', '2026-03-15', 'AKTIF', 0, '2026-03-15 10:21:47', '2026-05-04 13:56:30'),
(13, 12, 'BM0001', 'Budi Macet', 'KARYAWAN TETAP', '3698520147898', '-', '01010101', 'Jalan Nangkka no 19 Kediri', '2025-01-01', 'AKTIF', 0, '2026-04-02 08:30:50', '2026-05-08 14:02:44'),
(14, 13, 'P0001', 'Prabroro', 'KARYAWAN TETAP', NULL, NULL, NULL, NULL, '2026-04-04', 'AKTIF', 0, '2026-04-04 09:09:51', '2026-05-04 13:57:41'),
(15, 15, 'AR0001', 'Anggi Rita Kristantoe', 'KARYAWAN TETAP', '7854120', NULL, '08552121887', NULL, '2026-04-23', 'AKTIF', 0, '2026-04-23 12:58:51', '2026-05-07 19:36:19'),
(16, 17, 'AS0001', 'Ahmad Sutadji Handoyonieeeee', 'KARYAWAN KONTRAK', '----', '', '123123', '', '2026-04-24', 'AKTIF', 0, '2026-04-24 12:48:06', '2026-05-08 13:55:54'),
(17, 20, 'AQ0001', 'Abdul Qadir', 'DOSEN TETAP', '123456', '-', '11111111111', '-', '2026-05-02', 'AKTIF', 0, '2026-05-02 19:57:44', NULL),
(18, 21, 'Y0001', 'Yulianto', 'DOSEN TETAP', '345678', '-', '-', '-', '2026-05-02', 'AKTIF', 0, '2026-05-02 22:22:47', NULL),
(19, 22, 'Y0002', 'Yuliani', 'DOSEN TETAP', '-', '-', '-', '-', '2026-05-02', 'AKTIF', 0, '2026-05-02 22:23:14', NULL);
...
CREATE TRIGGER `sync_status_ke_users` AFTER UPDATE ON `anggota` FOR EACH ROW BEGIN
    -- Jika status berubah dari AKTIF ke NONAKTIF
    IF NEW.status = 'NONAKTIF' THEN
        UPDATE users SET is_active = 0 WHERE id = NEW.user_id;
    -- Jika status berubah dari NONAKTIF ke AKTIF
...
(409, NULL, 'FAILED_LOGIN', 'users', NULL, 'Failed login attempt for username: teller1', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 11:37:35'),
(410, 1, 'LOGIN', 'users', 1, 'User logged in successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 11:38:36'),
(411, 1, 'LOGIN', 'users', 1, 'User logged in successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 12:09:16'),
(412, 1, 'LOGIN', 'users', 1, 'User logged in successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 12:10:21'),
(413, 1, 'LOGOUT', 'users', 1, 'User Administrator logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 12:15:49'),
(414, 0, 'LOGIN', 'users', 0, 'User logged in successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 12:16:04'),
(415, 0, 'FORCE_CHANGE_PASSWORD', 'users', 0, 'User performed mandatory password reset', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 12:16:50'),
(416, 0, 'LOGOUT', 'users', 0, 'User Wahyu Kontol logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 12:17:35'),
(417, 1, 'LOGIN', 'users', 1, 'User logged in successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 12:17:43'),
(418, 1, 'LOGOUT', 'users', 1, 'User Administrator logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 12:21:49'),
(419, NULL, 'FAILED_LOGIN', 'users', NULL, 'Failed login attempt for username: W0001', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 12:22:14'),
(420, NULL, 'FAILED_LOGIN', 'users', NULL, 'Failed login attempt for username: W0002', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 12:22:28'),
(421, NULL, 'FAILED_LOGIN', 'users', NULL, 'Failed login attempt for username: W0002', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 12:22:57'),
(422, 1, 'LOGIN', 'users', 1, 'User logged in successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 12:23:06'),
(423, 1, 'LOGOUT', 'users', 1, 'User Administrator logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 12:24:01'),
(424, 19, 'LOGIN', 'users', 19, 'User logged in successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 12:24:13'),
(425, 19, 'UPDATE_INTEREST_RATES', 'setting_koperasi', 1, 'Bunga updated: Pendek=1.00%, Panjang=5%', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 12:25:10'),
(426, 19, 'LOGOUT', 'users', 19, 'User Manager logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 12:25:18'),
(427, NULL, 'FAILED_LOGIN', 'users', NULL, 'Failed login attempt for username: A003', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 12:25:31'),
(428, 1, 'LOGIN', 'users', 1, 'User logged in successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 12:25:50'),
(429, 1, 'LOGOUT', 'users', 1, 'User Administrator logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 12:27:32'),
(430, NULL, 'FAILED_LOGIN', 'users', NULL, 'Failed login attempt for username: Y0001', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 12:27:38'),
(431, 1, 'LOGIN', 'users', 1, 'User logged in successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 12:27:46'),
(432, 1, 'LOGOUT', 'users', 1, 'User Administrator logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 12:28:10'),
(433, 17, 'LOGIN', 'users', 17, 'User logged in successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 12:28:18'),
(434, 17, 'FORCE_CHANGE_PASSWORD', 'users', 17, 'User performed mandatory password reset', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 12:28:40'),
(435, 17, 'LOGOUT', 'users', 17, 'User Ahmad Sutadji Handoyono logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 12:29:01'),
(436, 1, 'LOGIN', 'users', 1, 'User logged in successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 12:29:06'),
(437, 1, 'UPDATE_INTEREST_RATES', 'setting_koperasi', 1, 'Bunga updated: Pendek=1.00%, Panjang=0.6%', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 12:29:31'),
(438, 1, 'LOGOUT', 'users', 1, 'User Administrator logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 14:00:43'),
(439, NULL, 'FAILED_LOGIN', 'users', NULL, 'Failed login attempt for username: A001', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 14:00:52'),
(440, 1, 'LOGIN', 'users', 1, 'User logged in successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 14:01:06'),
(441, 1, 'LOGIN', 'users', 1, 'User logged in successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 15:21:06'),
(442, 1, 'LOGOUT', 'users', 1, 'User Administrator logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 16:05:04'),
(443, NULL, 'FAILED_LOGIN', 'users', NULL, 'Failed login attempt for username: ketua', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 16:05:07'),
(444, NULL, 'FAILED_LOGIN', 'users', NULL, 'Failed login attempt for username: manager', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 16:05:11'),
(445, 3, 'LOGIN', 'users', 3, 'User logged in successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 16:05:23'),
(446, 3, 'LOGOUT', 'users', 3, 'User Manager logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 16:08:33'),
(447, 1, 'LOGIN', 'users', 1, 'User logged in successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 16:08:44'),
(448, 1, 'LOGIN', 'users', 1, 'User logged in successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 16:59:28'),
(449, 1, 'LOGIN', 'users', 1, 'User logged in successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 17:34:31'),
(450, 1, 'LOGOUT', 'users', 1, 'User Administrator logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 18:12:34'),
(451, 3, 'LOGIN', 'users', 3, 'User logged in successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 18:12:38'),
(452, 3, 'LOGOUT', 'users', 3, 'User Manager logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 18:12:48'),
(453, 1, 'LOGIN', 'users', 1, 'User logged in successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 18:21:04'),
(454, 1, 'LOGOUT', 'users', 1, 'User Administrator logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 18:26:17'),
(455, 3, 'LOGIN', 'users', 3, 'User logged in successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 18:26:21'),
(456, 3, 'LOGOUT', 'users', 3, 'User Manager logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 18:27:39'),
(457, 1, 'LOGIN', 'users', 1, 'User logged in successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 18:27:43'),
(458, 1, 'LOGOUT', 'users', 1, 'User Administrator logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 20:58:01'),
(459, 3, 'LOGIN', 'users', 3, 'User logged in successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 20:58:06'),
(460, 3, 'LOGOUT', 'users', 3, 'User Manager logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 20:59:28'),
(461, 1, 'LOGIN', 'users', 1, 'User logged in successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 20:59:36'),
(462, 1, 'LOGOUT', 'users', 1, 'User Administrator logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 21:00:41'),
(463, 3, 'LOGIN', 'users', 3, 'User logged in successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 21:00:45'),
(464, 3, 'LOGOUT', 'users', 3, 'User Manager logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 21:01:54'),
(465, 1, 'LOGIN', 'users', 1, 'User logged in successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 21:01:58'),
(466, 1, 'VERIFIKASI_PINJAMAN', 'pinjaman', 17, 'Pinjaman #17 telah diverifikasi.', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 21:14:11'),
(467, 1, 'LOGOUT', 'users', 1, 'User Administrator logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 21:25:14'),
(468, NULL, 'FAILED_LOGIN', 'users', NULL, 'Failed login attempt for username: budi', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 21:25:22'),
(469, NULL, 'FAILED_LOGIN', 'users', NULL, 'Failed login attempt for username: budi', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 21:25:31'),
(470, NULL, 'FAILED_LOGIN', 'users', NULL, 'Failed login attempt for username: user', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 21:25:40'),
(471, NULL, 'FAILED_LOGIN', 'users', NULL, 'Failed login attempt for username: budi', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 21:25:52'),
(472, NULL, 'FAILED_LOGIN', 'users', NULL, 'Failed login attempt for username: W0002', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 21:27:51'),
(473, NULL, 'FAILED_LOGIN', 'users', NULL, 'Failed login attempt for username: W0002', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 21:28:05'),
(474, 1, 'LOGIN', 'users', 1, 'User logged in successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-04 21:29:08'),
(475, 1, 'LOGIN', 'users', 1, 'User logged in successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-05 19:10:47'),
(476, 1, 'LOGOUT', 'users', 1, 'User Administrator logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-05 19:16:56'),
(477, 15, 'LOGIN', 'users', 15, 'User logged in successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-05 19:17:02'),
(478, 15, 'FORCE_CHANGE_PASSWORD', 'users', 15, 'User performed mandatory password reset', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-05 19:17:32'),
(479, 15, 'LOGOUT', 'users', 15, 'User Anggi Rita Kristanto logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-05 19:17:57'),
(480, 1, 'LOGIN', 'users', 1, 'User logged in successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-05 19:18:01'),
(481, 1, 'CHANGE_PASSWORD', 'users', 1, 'User changed password successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-05 19:20:44'),
(482, 1, 'LOGOUT', 'users', 1, 'User Administrator logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-05 19:20:59'),
(483, 1, 'LOGIN', 'users', 1, 'User logged in successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-05 19:21:07'),
(484, 1, 'LOGIN', 'users', 1, 'User logged in successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-06 12:29:49'),
(485, 1, 'LOGIN', 'users', 1, 'User logged in successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-07 13:19:34'),
(486, 1, 'LOGIN', 'users', 1, 'User logged in successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-07 18:30:07'),
(487, 1, 'LOGOUT', 'users', 1, 'User Administrator logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-07 20:04:27'),
(488, 1, 'LOGIN', 'users', 1, 'User logged in successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-07 20:04:29'),
(489, 1, 'CHANGE_PASSWORD', 'users', 1, 'User changed password successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-07 20:37:54'),
(490, 1, 'LOGIN', 'users', 1, 'User logged in successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-08 13:20:53'),
(491, 1, 'LOGOUT', 'users', 1, 'User Administrator logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-08 14:06:47'),
(492, 1, 'LOGIN', 'users', 1, 'User logged in successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-08 14:06:51'),
(493, 1, 'LOGIN', 'users', 1, 'User logged in successfully', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '2026-05-09 18:21:41');
...
(17, 3, '2026-04-22', 1000000.00, 12, 'FLAT', 1.50, 0.00, 'coba', 'DIVERIFIKASI', NULL, NULL, '2026-04-22 11:22:11', '2026-05-04 21:14:11', 1, '2026-05-04 21:14:11', '', NULL, NULL, NULL),
...
(1, 1.50, 5.00, 3.00, 12, 0.00, 20000.00, '2026-05-04 12:29:31', 1.00, 0.60);
...
(0, 'Wahyu ', 'w0002@ksp.local', 'W0002', '$2y$10$hGj1si7tuxFqgulirPSbd.LFCidHEdOKSqOkLHsR4WmSAArMJHMeG', 'ANGGOTA', 0, '2026-05-04 12:16:04', '2026-05-04 12:13:49', '2026-05-04 12:21:43'),
(1, 'Administrator', 'admin@ksp.com', 'admin', '$2y$10$NybaNioY2tj.5XwnOzrLUeQlBMH.QtQBJKbxWribwPJWhUV832y8.', 'VALIDATOR', 1, '2026-05-09 18:21:41', '2026-03-15 09:45:52', '2026-05-09 18:21:41'),
(2, 'BAU', 'bau@ksp.com', 'bau', '$2y$12$nozQxoXgzIQ4hZs1RxhpheEsVwl1/SBEmba8ZfUYjpAsD4dtiQA3i', 'BAU', 1, '2026-04-21 20:14:04', '2026-03-15 09:45:52', '2026-04-23 09:50:35'),
(3, 'Manager', 'manager@ksp.com', 'ketua', '$2y$12$lfAiODopbk0p4th1BiMHZOUCFN8S5Rnkm3hz/5.s7W.yCWBKHAzIW', 'MANAGER', 1, '2026-05-04 21:00:45', '2026-03-15 09:45:52', '2026-05-04 21:00:45'),
...
(12, 'Budi Macet', 'budiman@ksp.com', 'budiman', '$2y$12$isU/1sB8uQ/fTURT60qZiuvIADb1KUg4bXKIJxrDO10fB.6cGBk5a', 'ANGGOTA', 1, '2026-04-02 13:04:36', '2026-04-02 08:30:50', '2026-05-08 14:02:44'),
...
(15, 'Anggi Rita Kristantoe', 'ar0001@ksp.local', 'AR0001', '$2y$10$oAkH86SC25YA3V89RgR4neBxHHVWCIwGSfLuGqtuS9xX7SPwEyiZa', 'ANGGOTA', 1, '2026-05-05 19:17:02', '2026-04-23 12:58:51', '2026-05-07 19:36:19'),
(17, 'Ahmad Sutadji Handoyonieeeee', 'as0001@ksp.local', 'AS0001', '$2y$10$4myxvszPoTUvPRVP8m8NvOW3UyHvwJJwQ0PhLzu2uVR0Vk4XtLK4u', 'ANGGOTA', 1, '2026-05-04 12:28:18', '2026-04-24 12:48:06', '2026-05-08 13:55:54'),
...
(19, 'Manager', 'bendahara@KSP.com', 'manager', '$2y$12$6aIu/E6rpkwtB7Luu.cffev93aQnlsWH53GLkXfY/a17svNR6zkCC', 'MANAGER', 1, '2026-05-04 12:24:13', '2026-05-02 04:19:18', '2026-05-04 12:24:13'),
