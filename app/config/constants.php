...
// Anggota Tipe
define('TIPE_DOSEN_TETAP', 'DOSEN TETAP');
define('TIPE_DOSEN_KONTRAK', 'DOSEN KONTRAK');
define('TIPE_DOSEN_TIDAK_TETAP', 'DOSEN TIDAK TETAP');
define('TIPE_KARYAWAN_TETAP', 'KARYAWAN TETAP');
define('TIPE_KARYAWAN_KONTRAK', 'KARYAWAN KONTRAK');
define('TIPE_KARYAWAN_TIDAK_TETAP', 'KARYAWAN TIDAK TETAP');
