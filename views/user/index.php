<div class="mb-4 d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
    <div>
        ...
        <p class="text-muted small mb-0">Kelola akses akun administrator, teller, ketua, dan anggota.</p>
    </div>
    <div class="d-flex flex-wrap gap-2 align-items-center">
        <div class="input-group input-group-sm shadow-sm" style="width: 250px;">
            ...
            <input type="text" id="userSearchInput" class="form-control border-start-0 ps-0" placeholder="Cari Nama/Email/Username...">
        </div>
        <a href="<?= url('/users/create') ?>" class="btn btn-primary btn-sm shadow-sm px-3 d-flex align-items-center gap-2">
        ...
        <div class="card-body p-0">
            ...
            <div class="d-flex justify-content-between align-items-center p-3 border-top bg-light rounded-bottom">
                ...
                <div class="btn-group shadow-sm">
                    <button id="user-prev-btn" class="btn btn-white border btn-sm text-primary fw-semibold" onclick="changeUserPage(-1)">
                        <i class="bi bi-chevron-left me-1"></i> Prev
                    </button>
                    <button id="user-next-btn" class="btn btn-white border btn-sm text-primary fw-semibold" onclick="changeUserPage(1)">
