            ...
            <div class="card border-0 shadow-sm bg-primary text-white p-2">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <p class="small text-white-50 mb-0">Akses penuh ke seluruh sistem, manajemen user, dan
                            pengaturan sistem.</p>
                    </div>
                    <div class="mb-3">
                        <div class="fw-bold fs-6">TELLER</div>
                        <p class="small text-white-50 mb-0">Melayani transaksi simpanan, angsuran, dan pendaftaran
                            anggota.</p>
                    </div>
                    <div class="mb-3">
                        <div class="fw-bold fs-6">KETUA</div>
                        <p class="small text-white-50 mb-0">Memiliki akses ke seluruh laporan transaksi dan audit log.
                        </p>
                    </div>
                    <div>
                        <div class="fw-bold fs-6">ANGGOTA</div>
                        <p class="small text-white-50 mb-0">Akses personal untuk melihat saldo, riwayat transaksi, dan
                            tagihan.</p>
                    </div>
                </div>
            </div>
